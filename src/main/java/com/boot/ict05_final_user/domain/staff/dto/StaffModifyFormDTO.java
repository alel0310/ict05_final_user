...
public class StaffModifyFormDTO {
    ...
    private com.boot.ict05_final_user.domain.staff.entity.StaffEmploymentType staffEmploymentType;

    /**
     * 사원 부서 (관리팀, 판매팀)
     */
    @NotNull(message = "직원 부서를 선택해주세요")
    private com.boot.ict05_final_user.domain.staff.entity.StaffDepartment staffDepartment;
